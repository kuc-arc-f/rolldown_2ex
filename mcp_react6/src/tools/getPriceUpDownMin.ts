...
// getPriceUpDownMin 最低金額: 100 円 , 最高金額: 200 円の範囲内で最低値を返す
export const getPriceUpDownMin = tool({
  description: "購入品リスト 最低金額以上、最高金額以下の範囲内で最低値を返す。",
  parameters: z.object({
